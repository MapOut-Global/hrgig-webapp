    ...
    <React.Fragment>
      <div className=' flex h-screen w-full items-center justify-center  '>
        <div className=' mt-24'>
          ...
          <div className='flex items-center justify-end'> <div className='flex items-center justify-center bg-Grey-Blue text-white py-4 px-20 rounded-40 mt-4 mb-4 '>Sign Up</div> </div>
